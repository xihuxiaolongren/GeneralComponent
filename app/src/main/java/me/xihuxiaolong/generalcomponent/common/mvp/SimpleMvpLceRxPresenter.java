 ...
 * @since 1.0.0
 */
public abstract class SimpleMvpLceRxPresenter<V extends MvpLceView<M>, M>
  ...
  public Subscriber<M> subscribe(final boolean pullToRefresh) {
    ...
    subscriber = new Subscriber<M>() {
      ...
      @Override public void onCompleted() {
        SimpleMvpLceRxPresenter.this.onCompleted();
      }

      @Override public void onError(Throwable e) {
        SimpleMvpLceRxPresenter.this.onError(e, ptr);
      }

      @Override public void onNext(M m) {
        SimpleMvpLceRxPresenter.this.onNext(m);
      }
    };
