 ...
 * Date: 16/7/5.
 */
public class CityListFragment extends MvpLceFragment<RelativeLayout, List<List<City>>, CityListContract.IView, CityListFragmentPresenter> implements CityListContract.IView, OnQuickSideBarTouchListener {
